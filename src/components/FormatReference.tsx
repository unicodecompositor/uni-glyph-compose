        ...
        <div className="space-y-4 text-sm">
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-muted-foreground text-xs">
              ...
              <li><span className="text-primary font-mono">sp=</span> — parallelogram (sp="angle,force")</li>
              <li><span className="text-primary font-mono">st=</span> — trapezoid (st="angle,force")</li>
